export const messages = {
  'zh-CN': {
    ...
    'providers.quota.reset.daily': '每日重置',
    'providers.quota.reset.intervalDays': '每 {days} 天重置',
    'providers.quota.window.daily': '日限额',
    'providers.quota.window.weekly': '周限额',
    'providers.quota.window.monthly': '月限额',
    'providers.quota.localSynced': '当前生效',
    'providers.quota.unlimited': '不限',
    'providers.quota.allUnlimited': '日、周、月均不限',
    'providers.quota.expires': '套餐到期：{date}',
    'providers.quota.syncNotApplied': '最新远程额度未应用，本地额度保持不变',
    'providers.quota.exhausted': '额度已用尽',
    'providers.quota.awaitingSync': '等待首次成功同步',
    'providers.quota.retainedLocal': '当前本地额度',
  ...
  'en-US': {
    ...
    'providers.quota.reset.daily': 'Resets daily',
    'providers.quota.reset.intervalDays': 'Resets every {days} days',
    'providers.quota.window.daily': 'Daily limit',
    'providers.quota.window.weekly': 'Weekly limit',
    'providers.quota.window.monthly': 'Monthly limit',
    'providers.quota.localSynced': 'Active',
    'providers.quota.unlimited': 'Unlimited',
    'providers.quota.allUnlimited': 'Daily, weekly, and monthly are unlimited',
    'providers.quota.expires': 'Subscription expires: {date}',
    'providers.quota.syncNotApplied': 'The latest remote quota was not applied; local quota is unchanged',
    'providers.quota.exhausted': 'Quota exhausted',
    'providers.quota.awaitingSync': 'Waiting for the first successful sync',
    'providers.quota.retainedLocal': 'Current local quota',
